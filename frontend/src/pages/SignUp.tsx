...
export default function SignUp() {
	...
	async function handleSubmit(e: FormEvent) {
		...
		setError(null)
		try {
			const res = await api.post<JwtResponse>('/auth/signup', { username, email, password })
	...
	return (
		<div className="max-w-md mx-auto">
			...
			<p className="text-sm mt-3 text-gray-600">Already have an account? <Link to="/signin" className="text-indigo-600">Sign in</Link></p>
		</div>
	)
}
